...
export const importCtx = (): Promise<typeof import('neapolitan-ctx').default> =>
  import('neapolitan-ctx').then((mod) => mod.default);
export const importInput = (): Promise<
  typeof import('neapolitan-input').default
> => import('neapolitan-input').then((mod) => mod.default);
